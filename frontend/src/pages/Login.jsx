                            ...
                            <form action="#" className="mt-4">
                                ...
                                <div className="form-group mb-4">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input type="email" className="form-control" placeholder="example@company.com" id="email" autoFocus required value={email} onChange={onChangeEmail}/>
                                    </div>  
                                </div>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="form-group mb-4">
                                        ...
                                        <div className="input-group">
                                            <span clas="input-group-text" id="basic-addon2">
                                            ...
                                            <input type="password" placeholder="Password" className="form-control" id="password" required value={password} onChange={onChangePassword} />
                                        </div>  
                                    </div>
                                </div>
