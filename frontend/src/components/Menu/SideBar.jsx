...
function SideBar() {
    ...
    return (
        <nav id="sidebarMenu" className="sidebar d-lg-block bg-gray-800 text-white" data-simplebar>
                ...
                <ul className="nav flex-column pt-3 pt-md-0">
                    <li className="nav-item">
                        <a href="/dashboard" className="nav-link d-flex align-items-center">
                            ...
                            <span className="mt-1 ms-1 sidebar-text">B3holder</span>
                        </a>
                    </li>
                    ...
                    <SideBarItem to="/ordertemplates" text="Order Templates">
                        <svg className="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <SideBarItem to="#" text="Logout" onClick={btnLogoutClick}>
                        <svg className="icon" fill="none" strokeWidth="2.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
