            ...
            <div className="sidebar-inner px-4 pt-3">
                <ul className="nav flex-column pt-3 pt-md-0">
                    ...
                    <SideBarItem to="/ordertemplates" text="Order Templates">
                        <svg className="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <SideBarItem to="/logout" text="Logout">
                        <svg className="icon" fill="none" stroke-width="2.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
